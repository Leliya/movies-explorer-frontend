...
function MoviesCardList({ cardsArrayMain,
  ...
  return (
    <>
      ...
      {
      //!infoMessage.message ? <div className="cardList__empty"><span className="cardList__notFound">{infoMessage.message}</span></div> :
        //cardsArrayMain.length === 0||infoMessage.message ? <div className="cardList__empty"><span className="cardList__notFound">Ничего не найдено</span></div> :
